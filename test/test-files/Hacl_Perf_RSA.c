...
// /usr/local/Cellar/openssl@1.1/1.1.0g/include/openssl
...
int main() {
  ...
  (void)((pkeyBits - (uint32_t)1U) / (uint32_t)8U + (uint32_t)1U);
  uint8_t e[3U] = { (uint8_t)0x01U, (uint8_t)0x00U, (uint8_t)0x01U };
  uint32_t skeyBits = (uint32_t)2048U;
  (void)((skeyBits - (uint32_t)1U) / (uint32_t)8U + (uint32_t)1U);
  uint8_t
  d[256U] =
    {
  ...
  for (int i = 0; i < 100; i++){
    ctest(modBits, n1, pkeyBits, e, skeyBits, d, msg_len, msg, 0, NULL, sgnt);
  }
