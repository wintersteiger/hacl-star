...
val gcm256_decrypt_opt':
  ...
  Stack UInt64.t
    ...
    (ensures fun h0 c h1 ->
      ...
      (let plain, result = gcm_decrypt_LE AES_256 (seq_nat32_to_seq_nat8_LE (Ghost.reveal key)) (Ghost.reveal iv) cipher_bytes auth_bytes expected_tag in
...
inline_for_extraction
let gcm256_decrypt_opt_alloca key iv cipher_b cipher_len auth_b auth_bytes iv_b
...
let gcm256_decrypt_opt_stdcall key iv cipher_b cipher_len auth_b auth_len iv_b out_b tag_b keys_b hkeys_b scratch_b =
  ...
  let c = gcm256_decrypt_opt_alloca
    key
    iv
    cipher_b'
    cipher_len
  ...
  assert (
    ...
    let plain, result = gcm_decrypt_LE AES_256 (seq_nat32_to_seq_nat8_LE (Ghost.reveal key)) (Ghost.reveal iv) cipher auth expected_tag in
