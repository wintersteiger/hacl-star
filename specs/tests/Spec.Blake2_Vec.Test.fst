...
let test () =
  ...
  let test1_result : lbytes 32 =
    Spec.Blake2_Vec.blake2s test1_plaintext 0 (assert_norm (List.Tot.length ([] <: list uint8) <= max_size_t); of_list []) 32
  in
  ...
  let test2_result : lbytes 32 =
    Spec.Blake2_Vec.blake2s test2_plaintext 32 test2_key  32
  in
  ...
  let test3_result : lbytes 32 =
    Spec.Blake2_Vec.blake2s test3_plaintext 32 test3_key  32
  in
  ...
  let test4_result : lbytes 32 =
    Spec.Blake2_Vec.blake2s test4_plaintext 32 test4_key  32
  in
  ...
  let test5_result : lbytes 64 =
    Spec.Blake2_Vec.blake2b test5_plaintext 0 (of_list []) 64
  in
  ...
  let test6_result : lbytes 64 =
    Spec.Blake2_Vec.blake2b test6_plaintext 64 test6_key 64
  in
