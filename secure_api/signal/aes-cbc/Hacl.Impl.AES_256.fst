...
let inv_sbox : (b:ilbuffer uint8 (size 256){recallable b}) =
  [@ inline_let]
...
let sbox : (b:ilbuffer uint8 (size 256){recallable b}) =
   [@ inline_let]
  let l : list FStar.UInt8.t = [
