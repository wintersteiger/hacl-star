...
#set-options "--max_fuel 0 --initial_fuel 0 --initial_ifuel 0 --max_ifuel 0 --z3rlimit 50"
...
let encrypt
  ...
  let c0 : lbytes 1 = create 1 (((u8 3) <<. 4ul) |. (u8 3)) in
...
let decrypt
  ...
  let exp_tag8 =
      mac_whisper_msg mac_key our_identity_pub_key
			      their_identity_pub_key whisper_message in
