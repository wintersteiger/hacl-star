...
val loc_includes_gsub_buffer_r
  ...
  (len: Int.size_t)
: Lemma
  (requires (Int.size_v i + Int.size_v len <= (B.length b) /\ loc_includes l (loc_buffer b)))
  (ensures (Int.size_v i + Int.size_v len <= (B.length b) /\ loc_includes l (loc_buffer (B.gsub b i len))))
...
val loc_includes_gsub_buffer_l
  ...
  (len2: Int.size_t)
: Lemma
  (requires (Int.size_v i1 + Int.size_v len1 <= (B.length b) /\ Int.size_v i1 <= Int.size_v i2 /\ Int.size_v i2 + Int.size_v len2 <= Int.size_v i1 + Int.size_v len1))
  (ensures (Int.size_v i1 + Int.size_v len1 <= (B.length b) /\ Int.size_v i1 <= Int.size_v i2 /\ Int.size_v i2 + Int.size_v len2 <= Int.size_v i1 + Int.size_v len1 /\ loc_includes (loc_buffer (B.gsub b i1 len1)) (loc_buffer (B.gsub b i2 len2))))
...
: Lemma
  (requires (
    Int.size_v i1 + Int.size_v len1 <= (B.length b) /\
    Int.size_v i2 + Int.size_v len2 <= (B.length b) /\ (
    Int.size_v i1 + Int.size_v len1 <= Int.size_v i2 \/
    Int.size_v i2 + Int.size_v len2 <= Int.size_v i1
  )))
  (ensures (
    Int.size_v i1 + Int.size_v len1 <= (B.length b) /\
    Int.size_v i2 + Int.size_v len2 <= (B.length b) /\
