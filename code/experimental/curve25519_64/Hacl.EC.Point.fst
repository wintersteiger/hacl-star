...
unfold inline_for_extraction let getx p = Buffer.sub p 0ul 4ul
unfold inline_for_extraction let gety p = Buffer.sub p 0ul 4ul
unfold inline_for_extraction let getz p = Buffer.sub p 4ul 4ul
