...
)
{
  ...
  else
  {
    ...
    if (pow2_i1 == (uint32_t)1U)
    {
      ...
      Hacl_Impl_Multiplication_bn_mul_u64(FStar_UInt32_v(pow2_i0), pow2_i0, a0, b1_0, tmp01);
      Hacl_Impl_Multiplication_bn_mul_u64(FStar_UInt32_v(pow2_i0), pow2_i0, b0, a1_0, tmp1);
      Hacl_Impl_Addition_bn_add_carry(FStar_UInt32_v(tmp1Len),
        ...
        tmp1,
        tmp2);
      Hacl_Impl_Addition_bn_add(FStar_UInt32_v(tmp2Len),
        FStar_UInt32_v(tmp2Len),
        tmp2Len,
        res1,
        tmp2Len,
        tmp2,
...
)
{
  ...
  if (i < aaLen)
  {
    ...
    uu____1210 =
      {
        .fst = FStar_UInt128_uint128_to_uint64(FStar_UInt128_shift_right(FStar_UInt128_add(FStar_UInt128_add(FStar_UInt128_mul_wide(uu____1215,
                  l),
                FStar_UInt128_uint64_to_uint128(carry)),
              FStar_UInt128_uint64_to_uint128(res_ij)),
            (uint32_t)64U)),
        .snd = FStar_UInt128_uint128_to_uint64(FStar_UInt128_add(FStar_UInt128_add(FStar_UInt128_mul_wide(uu____1215,
                l),
              FStar_UInt128_uint64_to_uint128(carry)),
            FStar_UInt128_uint64_to_uint128(res_ij)))
      };
    K___uint64_t_uint64_t scrut = uu____1210;
    uint64_t carry_ = scrut.fst;
    uint64_t res_ij1 = scrut.snd;
    res[ij] = res_ij1;
    return
...
)
{
  ...
  if (i < bBits)
  {
    bool uu____1325 = Hacl_Impl_Lib_bn_is_bit_set(FStar_UInt32_v(bLen), bLen, b, i);
    if (uu____1325)
...
)
{
  ...
  acc[0U] = (uint64_t)1U;
  Hacl_Impl_Montgomery_bn_pow2_mod_n(FStar_UInt32_v(rrLen), modBits, rrLen, n11, exp2, r2);
  uint64_t n0 = n1[0U];
  uint64_t nInv_u64 = Hacl_Impl_Montgomery_mod_inv_u64(n0);
  Hacl_Impl_Exponentiation_mod_exp_mont(FStar_UInt32_v(rrLen),
    rrLen,
    pow2_i,
    iLen,
    bBits,
